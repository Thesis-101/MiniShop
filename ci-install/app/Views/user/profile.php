...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="container w-50 bg-light mt-5 p-5 rounded shadow">
        <div class="card">
            <h5 class="card-header">Profile Details</h5>
            <div class="card-body">
                <div class="profile-pic text-center mb-2">
                    <img src="<?= base_url('images/'.session()->avatar) ?>" alt="" width="300px" height="300px">
                </div>
                <h5 class="card-title text-center"><?= session()->name ?></h5>
                <p class="card-text text-center"><?= session()->email ?></p>
            </div>
        </div>
    </div>
