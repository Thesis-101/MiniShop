...
<body>
    ...
    <div class="container w-25 bg-light mt-5 p-5 rounded shadow mb-5">
        ...
        <form action="<?= base_url('item-setup/update/'.$item['id']) ?>" method="post" class="form">
            <?= csrf_field(); ?>
            <input type="hidden" name="_method" value="PUT">
            <div class="mb-3">
                <label class="form-label" for="item_name">Item Name :</label>
                <input class="form-control" type="text" name="item_name" id="item_name" value="<?= $item['item_name']; ?>">
            ...
            <button class="btn btn-md btn-primary form-control mb-2" type="submit">Update Item</button>
        </form>
